export const parserExamplePrompts = [
  ...
  "Trip dinner. Ali paid 95,000 KRW for chicken, rice, drinks and dessert. 5 people joined but Mira only had drinks. Split food between everyone except Mira, drinks between all 5.",
