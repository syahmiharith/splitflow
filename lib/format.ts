...
export function humanStatus(status: string): string {
  const labels: Record<string, string> = {
    proposal_draft: "Proposal Artifact",
    ...
    settlement_plan: "Settlement Readiness",
    settlement_ledger: "Claimed Payment Ledger",
    change_request_summary: "Change Requests",
    risk_summary: "Settlement Risk",
    draft: "Draft",
    sent: "Sent",
